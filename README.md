...
| [`sensor.html`](sensor.html) | El sensor en cuatro pestañas: datos medidos de M11, Q3 y SL3-S (ruido de lectura, ganancia dual, PDR, calculadora SNR), el multishot del SL3-S (Bayer animado, √N, Nyquist, deriva sidérea, software de apilado, asistente de decisión), la Triple Resolution de la M11 y la pestaña de difracción y diafragma: para cada sensor o modo (M11 L/M/S-DNG, SL3-S 24/96 MP, otros formatos, paso a medida) dice hasta qué diafragma cerrar sin perder detalle, cuántos megapíxeles rinde de verdad a cada f, si el multishot de 96 MP aporta algo a ese diafragma y cómo casa con la profundidad de campo pedida. Fusiona las antiguas leica-sensores, multishot-sl3s y binning-m11, que redirigen aquí. La pestaña de datos carga Chart.js desde CDN. | 190 KB |
