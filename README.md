...
| [`exposicion-larga.html`](exposicion-larga.html) | Exposición larga: las seis técnicas de la chuleta de Pit Haupert con el tiempo que piden en tu escena, no el de la receta. Calcula el arrastre del sujeto en píxeles (b = f·v·t/(d·p)), si lo sostienes a pulso con la escalera de apoyos (codos, correa tensada, apoyo, OIS, IBIS, trípode), qué filtro hace falta y qué ISO sin él. Con franja del sensor a escala, curva de arrastre frente a trepidación y comparación de los tres cuerpos. | 63 KB |
